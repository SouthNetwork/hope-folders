...
AddEventHandler("vRP:playerActive",function(user_id,name)
	...
	SetDiscordAppId(1202031465739866122)
	SetDiscordRichPresenceAsset("hope-dev")
	SetRichPresence("#"..user_id.." "..name)
	SetDiscordRichPresenceAssetSmall("hope-dev")
	SetDiscordRichPresenceAssetText("Hope")
	SetDiscordRichPresenceAssetSmallText("Hope")
	SetDiscordRichPresenceAction(0,"Hope","https://discord.gg/yZsVJyvP")
	SetDiscordRichPresenceAction(1,"Instagram","http://www.creative-rp.com/")
