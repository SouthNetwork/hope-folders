...
-----------------------------------------------------------------------------------------------------------------------------------------
Hope = {}
Tunnel.bindInterface("works",Hope)
...
-- COLLECTCONSUME
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.collectConsume(serviceName)
	local source = source
...
-- DELIVERYCONSUME
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.deliveryConsume(serviceName)
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
...
-- CHECKPERMISSION
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.checkPermission(serviceName)
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
