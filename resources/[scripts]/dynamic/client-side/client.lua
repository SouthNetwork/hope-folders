		...
		if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and MumbleIsConnected() then
			...
			if GetEntityHealth(ped) > 101 then
				...
				if LocalPlayer["state"]["Police"] then
					...
					exports["dynamic"]:AddButton("Soldado","Fardamento de Aluno.","player:presetFunctions","2","prePolice",true)
					exports["dynamic"]:AddButton("Aluno","Fardamento de Aluno.","player:presetFunctions","1","prePolice",true)
					...
					exports["dynamic"]:AddButton("Computador","Computador de bordo policial.","police:MdtHope","",false,false)
