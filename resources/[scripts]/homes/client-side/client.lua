...
-----------------------------------------------------------------------------------------------------------------------------------------
Hope = {}
Tunnel.bindInterface("homes",Hope)
...
-- UPDATEHOMES
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.updateHomes(homesTable)
	local innerTable = {}
...
-- ENTRANCEHOMES
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.entranceHomes(homeName,v,interior,theft)
	DoScreenFadeOut(0)
...
-- HOMEGARAGE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.homeGarage(homeName)
	homes["garage"] = 0
	local homeCoords = {}
	homeCoords[homeName] = {}
