...
-----------------------------------------------------------------------------------------------------------------------------------------
Hope = {}
Tunnel.bindInterface("police",Hope)
...
-- INITPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.initPrison(nuser_id,services,fines,text)
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
...
-- SEARCHUSER
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.searchUser(nuser_id)
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
...
-- INITFINE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.initFine(nuser_id,fines,text)
	local source = source
	local user_id = vRP.getUserId(source)
...
-- UPDATEPORT
-----------------------------------------------------------------------------------------------------------------------------------------
function Hope.updatePort(nuser_id)
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
